  ...
  groups: [
    {
      ...
      fields: [
        ...
        // },
        {
          ...
          type: 'boolean',
          ui_hint: 'checkbox',
          en_label: 'Disable windows sleep mode',
          zh_label: '禁用系统防锁定/休眠',
          description_en: 'When enabled, it prevents the computer from entering sleep mode, ensuring the AI assistant can run uninterrupted.',
          description_zh: '启用后，可防止计算机进入睡眠模式，确保AI助手能够不间断地运行。',
        },
        {
          key: 'resumeImporter',
          type: 'action',
          ...
          zh_label: '智能简历导入',
          description_en: 'After the AI assistant finishes importing, please review the information and click the "Save" button at the bottom right to save all settings.',
          description_zh: 'AI助手完成导入后，请检查信息并点击右下角的"保存"按钮以保存所有设置。',
          button: {
            key: 'run_importer',
    ...
    {
      key: 'job_filters',
      group_name_en: 'Position and Preferences',
      group_name_zh: '职位与偏好设置',
      fields: [
        {
        ...
        },
        {
            ...
            type: 'boolean',
            ui_hint: 'checkbox',
            en_label: 'Are you a U.S. citizen, national, or lawful permanent resident?',
            zh_label: '您是美国公民、国民还是合法永久居民？',
        },
        {
          key: 'experienceLevel',
          type: 'object',
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                en_label: 'Custom Q&A',
                zh_label: '自定义问答',
                description_en: 'Provide answers to custom questions that might be asked during application.',
                description_zh: '针对在申请过程中可能遇到的自定义问题提供答案',
